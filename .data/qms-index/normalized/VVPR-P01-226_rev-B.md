# VVPR-P01-226 Rev B: MX1 Residual Radiation Verification Protocol Report

## Metadata
- Document ID: VVPR-P01-226
- Revision: B
- Prefix: VVPR
...
- Source filename: VVPR-P01-226 - MX1 Residual Radiation Verification Protocol  Report_B-signed.docx
- Source path: Example QMS - MedAI/VVPR-P01-226 - MX1 Residual Radiation Verification Protocol  Report_B-signed.docx
- Extraction warnings: none

## Extracted Content
Protocol Section
STUDY PURPOSE
The purpose of this study is to verify residual radiation measurements are within specification for the MX1 Portable X-ray System with the IRAY A0 detector.
OBJECTIVE
The objective of this study is to collect residual radiation dosimetric information for the MX1 System incorporating an IRAY A0 detector  in accordance with IEC 60601-2-54.
REFERENCES
IEC 60601-2-54 Edition 2.0 2022 Medical electrical equipment – Part 2-54: Particular requirements for the basic safety and essential performance of X-ray equipment for radiography and radioscopy Section  203.11.102  “Test for attenuation of residual radiation”
IFU-MX1 Rev. G- Instructions for Use
MATERIALS
Equipment:
...
Weigh the MX1 Cassette, C1 and record the value for information only.
...
Tested By: ______________________________________________   Date:________________________________
...
MX1 Portable X-ray System Rev E  Components:
Cassette weight: 5.987 kg, for reference only
Table A.4: Device Configuration
*IRAY Detector in this Cassette weighed 2.10kg. Detector weight ≤ 2.25kg is an A0 model. See NCR-123 for data.
Tested By: Riley Compton    Date: Oct 11, 2024
RESULTS
Data Collection
...
The A0 detector evaluated in this study yielded equivalent results to the A1 detector previously tested in VVPR-P01-155.
REPORT APPROVAL
Digital Key:
example.com/
...
| --- | --- | --- | --- | --- |
| A | Initial Release | Engineering Quality Engineering Regulatory Affairs | 06 Feb 2026 | 25-086 |
...
| --- | --- | --- | --- | --- |
| EQP-158 | Radcal AGDM+ Accu-Gold Digitizer | 4-Sep-2024 | 4-Sep-2025 | Riley Compton 10/11/24 |
| EQP-159 | Radcal AGMS-DM+ Accu-Gold Multi-Sensor | 4-Sep-2024 | 4-Sep-2025 | Riley Compton 10/11/24 |
| T-129 | EOL Testing Fixture | N/A | N/A | Riley Compton 10/11/24 |
| N/A | Accu-Gold 3.0 Radiation Measurement Software | N/A | N/A | Riley Compton 10/11/24 |
| T-182 | Aluminum Attenuator | N/A | N/A | Riley Compton 10/29/24 |

### Table 7
| Device Serial Number: | E1 Emitter: 1220   C1 Cassette: 1079* |
| --- | --- |
...
| Rev | Description of Change | Approved By | Approval Date: | DCO # |
| --- | --- | --- | --- | --- |
| B | Initial Report release | Engineering Quality Engineering Regulatory Affairs | 06 Feb 2025 | 25-087 |
