# MEMO-P01-777 Rev A: MX1 Software Design Specifications

## Metadata
- Document ID: MEMO-P01-777
- Revision: A
- Prefix: MEMO
...
- Source filename: MEMO-P01-777 - MX1 Software Design Specifications_A-Obsolete.docx
- Source path: Example QMS - MedAI/MEMO-P01-777 - MX1 Software Design Specifications_A-Obsolete.docx
- Extraction warnings: none

## Extracted Content
MEMO-P01-777 - MX1 Software Design Specifications_A-Obsolete
Sheet: Signoff
Sheet: Introduction
Sheet: JO
Sheet: EO
...
| MedAI MEDICAL, INC |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| Document: | MEMO-P01-777 - MX1 Software Design Specifications |  |  |  |  |
| Project: | P01 |  |  |  |  |
| APPROVALS / DOCUMENT REVISION HISTORY |  |  |  |  |  |
| Revision | DCO # | Approved By | Eff. Date | Description | Digital Key |
| A | 24-655 | EngineeringQuality Engineering | 2025-01-14 00:00:00 | Initial Release for v4.0.1Note* Starting with revision A, MEMO-P01-777 will contain the software design specifications pertaining to the split v4.x.x line of MX1 software releases.  Refer to Rev A through F (excluding rev D) MEMO-P01-631 - MX1 Software Design Specifications for design specifications pertaining to the v3.x.x line. | example.com/ |
...
| Scope |  |
| This document records the detailed design specifications for the individual Software Components that compose the MX1 Software System and MedAI Device App in accordance with the Software Detailed Design section defined in PLN-P01-024 - MX1 Software Development Plan.This document reflects behavior of the MX1 Software System as of the following version: |  |
| MX1 SS Version | v4.0.1 |
| References |  |
| IEC 62304:2015 - Medical device software - Software life cycle processes |  |
| PLN-P01-024 - MX1 Software Development Plan Rev. D |  |
| MEMO-P01-776 - MX1 Software Requirement Specifications Rev. A |  |
| Document Overview |  |
| The MX1 Software Design Specifications documents the specific design details to allow the MX1 Software System and MedAI Device App to meet requirements recorded in MEMO-P01-776 - MX1 Software Requirement Specifications.                 In this document, the Software Component Specifications are recorded in each individual tab. Each specification is linked to a driving MX1 Software System requirement. |  |
