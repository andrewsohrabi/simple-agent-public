# PLN-P01-024 Rev D: MX1 Software Development Plan
...
- Source filename: PLN-P01-024 - MX1 Software Development Plan_D-Obsolete.docx
- Source path: Example QMS - MedAI/PLN-P01-024 - MX1 Software Development Plan_D-Obsolete.docx
...
Software Updates identified through the Software Problem Resolution Process and Software Maintenance Process shall be conducted by authorized MedAI employees. The devices shall be returned to MedAI so that authorized personnel can update the device with the validated software update. Documentation of software updates will be performed in accordance with QSP-013, Servicing.
SOFTWARE RISK ANALYSIS
