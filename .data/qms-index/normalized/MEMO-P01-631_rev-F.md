# MEMO-P01-631 Rev F: MX1 Software Design Specifications
...
- Source filename: MEMO-P01-631 - MX1 Software Design Specifications_F.docx
- Source path: Example QMS - MedAI/MEMO-P01-631 - MX1 Software Design Specifications_F.docx
- Extraction warnings: none

## Extracted Content
MEMO-P01-631 - MX1 Software Design Specifications_F
Sheet: Signoff
Sheet: Introduction
Sheet: JO
Sheet: EO
...
| E | Refer to ECR-602 |  |  | Updates for MX1 SS v3.3.0 releaseNote* EMF-SDS-33 was implemented and EMF-SDS-27 removed in v3.2.0. Due to clerical error, they remained in revision C. The error has been corrected in revision E. | example.com/ |
| F | Refer to ECR-643 |  |  | Updates for MX1 SS v3.4.0 releaseNote* EMF-SDS-34 was implemented in v3.0.0. Due to clerical error, this specification was not recorded in any previous revision. The error has been corrected in revision F. | example.com/ |
...
| MEMO-P01-630 - MX1 Software Requirement Specifications Rev. H |  |
| Document Overview |  |
...
| Startup/OS Configuration | SRS-7.1 | JO-SDS-5 | JO shall enable the WPA3 protocol to encrypt all WiFi communications internal to the MX1 system |
...
| Emitter Movement Interlock - Fluoro | SRS-14.23SRS-14.24 | EO-SDS-42 | EO shall set and monitor a timer to keep track of the time since the last reported emitter movement |
| Emitter Movement Interlock - Fluoro | SRS-14.23SRS-14.24 | EO-SDS-43 | EO shall disallow radioscopic acquisition if timer is a value of less than 1000 ms |
| Emitter Movement Interlock - DDR | SRS-12.38SRS-12.39 | EO-SDS-45 | EO shall disallow serial radiographic acquisition if timer is a value of less than 1000 ms |
...
| DDR Display Delay | SRS-43.31 | CO-SDS-45 | When acquiring a serial radiographic image, CO shall display an image with "DDR starting" message for 2 seconds prior to displaying the first acquired frame. |
...
| LIDAR Comm Manager | SRS-16.1 | XRC-SDS-82 | XRC shall apply a configurable SSD offset that is 33.45 mm by default |
...
| GUI | SRS-16.8 | EMF-SDS-33 | EMF shall display the computed SID value |
| GUI | SRS-14.4 | EMF-SDS-34 | EMF shall display a set of crosshairs to indicate the perpendicularity status of the calculated beam angle to the computed cassette active area |
...
| Doctors page | SRS-33.1SRS-33.2 | ODA-SDS-49 | ODA shall display list of doctors registered on a unit |
