# PLN-P01-060 Rev C: MX1 Project Plan
...
- Source filename: PLN-P01-060 - MX1 Project Plan_C-signed.docx
- Source path: Example QMS - MedAI/PLN-P01-060 - MX1 Project Plan_C-signed.docx
...
Collimation Pucks
The Collimation Pucks may be used to collimate the X-ray beam to very small field sizes. Each puck can be identified by the two bolded numbers at the end of each puck’s part number.
MedAI Device App (MedAI APP)
The MedAI Device App (ODA) will allow a tablet or monitor to be connected to the MX1 System via a wireless connection to display the primary User Interface (UI). It will be available from the Google Play store for devices with Android version 10 and up.  Apple iOS may be supported in future software versions.
Accessories
...
Cart (K1)
The mobile cart is intended for use in the storage, transport, positioning, and use of MX1. The cart includes a touchscreen DICOM monitor and provides means to charge the MX1 system via USB-C power supply cables or a wireless charger (see Section 4.3.2). The cart also has a jointed arm for positioning the emitter.
Wireless Charger (W1)
...
Lab Kit (L2)
Based on user feedback in regards to L1, development has begun on its next revision, L2 with the same intended use.   L2 is also not intended to diagnose, treat, cure, or prevent any disease.
Tablet (T1)
...
NEW DESIGN FEATURES
An additional fluoroscopy mode will be added that is capable of capturing radioscopic images with the maximum technique factors of 64 kV and 0.08 mAs.
...
MARKETING STRATEGY
The MX1 Portable X-Ray System will be marketed and sold in the following clinical environments and countries.
Markets of Interest
Specialty Clinics
Clinical Labs
...
| --- | --- | --- |
| Hayden Beck (CEO) | Executive Management | Responsible for providing all departments with the resources necessary for successful completion of the project. Reviews project status and provides input during Phase reviews. Communicates project status to external stakeholders as applicable. |
...
| Cameron Rivera (QE) | Quality (QA) | Responsible for authoring quality deliverables per QSP-018, including the quality plan and risk analysis documentation. Collaborates with the Human Factors Team to determine usability deliverables. General review of design control deliverables for completeness and accuracy. Owns design phase closures. |
...
| Matt Beckham (EE Team Lead) | Product Development - Electrical Engineering | Responsible for all principal electrical system design and V&V support. Including high voltage design, circuits and PCBA design, and embedded system firmware design. |
...
| Skylar Knight (Manager, Marketing) | Marketing | Responsible for overseeing marketing strategies. |

### Table 2
| Project Milestones | Target Date |
| --- | --- |
| Phase 1 Review | March 2024 |
| Phase 2 Review | April 2024 |
| Phase 3 Review | October 2024 |
| Phase 4 Review | December 2024 |
...
| B | Updated references and dates in the project milestones | Quality Engineering Engineering Executive Mgmt Regulatory Affairs | 25 May 2024 | 24-276 |
| C | -Section 4.3.5 - Addition of L2 updates to L1 -Section 4.2.4 - Removed pediatric filter -Section 6 - Team resource changes -Section 7.3.1 -Changes to phase review timing -Section 9.1 - Changes to volumes for 2024 -Section 10.2 - Canada added to scope | Quality Engineering Engineering Executive Mgmt Regulatory Affairs | 25 Oct 2024 | 24-611 |
